  ...
  const projects = [
    {
      ...
      icon: BookOpen,
      liveUrl: "https://www.achieversstudy.com/",
    ...
    },
    {
      ...
      description:
        "A comprehensive resume builder web application that generates ATS-optimized resumes with pre-designed templates.",
      features: [
    ...
    },
    {
      ...
      description:
        "A comprehensive education-focused platform with user management, course listings, and AI chatbot integration.",
      features: [
    ...
    <section id="projects" className="bg-secondary/30 section-padding">
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Innovative solutions that showcase technical expertise and real-world
          impact
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
        {projects.map((project, index) => {
          ...
          return (
            <Card
              key={index}
              className="card-hover bg-gradient-card border-0 shadow-card h-full flex flex-col"
            >
              <CardHeader>
